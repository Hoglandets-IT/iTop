...
class SynchroDataSource extends cmdbAbstractObject
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeExternalKey('user_id', array(
			'targetclass' => 'User',
			'jointype' => null,
			'allowed_values' => null,
			'sql' => 'user_id',
		...
		MetaModel::Init_AddAttribute(new AttributeExternalKey('notify_contact_id', array(
			'targetclass' => 'Contact',
			'jointype' => null,
			'allowed_values' => null,
		...
		MetaModel::Init_AddAttribute(new AttributeString('scope_restriction', array(
			'allowed_values' => null,
...
//		MetaModel::Init_AddAttribute(new AttributeString("reconciliation_list", array("allowed_values"=>null, "sql"=>"reconciliation_list", "default_value"=>null, "is_null_allowed"=>false, "depends_on"=>array())));
		MetaModel::Init_AddAttribute(new AttributeEnum('reconciliation_policy', array(
		...
		MetaModel::Init_AddAttribute(new AttributeEnum('action_on_zero', array(
		...
		MetaModel::Init_AddAttribute(new AttributeEnum('action_on_one', array(
		...
		MetaModel::Init_AddAttribute(new AttributeEnum('action_on_multiple', array(
		...
		MetaModel::Init_AddAttribute(new AttributeEnum('delete_policy', array(
		...
		MetaModel::Init_AddAttribute(new AttributeString('delete_policy_update', array(
			'allowed_values' => null,
		...
		MetaModel::Init_AddAttribute(new AttributeDuration('delete_policy_retention', array(
			'allowed_values' => null,
		...
		MetaModel::Init_AddAttribute(new AttributeLinkedSet('attribute_list', array(
		...
		// Not used yet !
		MetaModel::Init_AddAttribute(new AttributeEnum('user_delete_policy', array(
		...
		MetaModel::Init_AddAttribute(new AttributeURL('url_icon', array(
			'allowed_values' => null,
			'sql' => 'url_icon',
			'default_value' => null,
			'is_null_allowed' => true,
		...
		MetaModel::Init_AddAttribute(new AttributeString('url_application', array(
			'allowed_values' => null,
			'sql' => 'url_application',
			'default_value' => null,
			'is_null_allowed' => true,
		...
		MetaModel::Init_SetZListItems('details', array(
				'col:0' => array(
					'fieldset:SynchroDataSource:Description' => array(
						'name',
						'description',
						'status',
						'scope_class',
				...
				'col:1' => array(
					'fieldset:SynchroDataSource:Reconciliation' => array(
						'reconciliation_policy',
						'action_on_zero',
						'action_on_one',
						'action_on_multiple',
					),
					'fieldset:SynchroDataSource:Deletion' => array(
						'user_delete_policy',
		...
		MetaModel::Init_SetZListItems('list',
			array('scope_class', 'status', 'user_id', 'full_load_periodicity')); // Attributes to be displayed for a list
		// Search criteria
		MetaModel::Init_SetZListItems('standard_search',
			array('name', 'status', 'scope_class', 'user_id')); // Criteria of the std search form
				...
				if ($oAttDef->IsWritable())
				{
					...
					if ($oAttribute !== null)
					{
						if (!$bEditMode)
						{
							...
							$aRow['attcode'] = MetaModel::GetLabel($this->GetTargetClass(),
									$oAttribute->Get('attcode')).' ('.$oAttribute->Get('attcode').')';
							...
							if ($oAttDef->IsExternalKey())
							{
								...
								switch ($sReconciliationAttCode)
								{
									...
									default:
										$sDisplayReconciliationAttCode = MetaModel::GetLabel($oAttDef->GetTargetClass(),
						...
						else
						{
							...
							$aRow['update_policy'] = cmdbAbstractObject::GetFormElementForField($oPage, get_class($oAttribute),
								'update_policy', $oUpdateAttDef, $oAttribute->Get('update_policy'), '', 'update_policy_'.$sAttCode,
								"[$sAttCode]");
							if ($oAttDef->IsExternalKey())
							{
								$aRow['reconciliation_attcode'] = $oAttribute->GetReconciliationFormElement($oAttDef->GetTargetClass(),
...
EOF
	...
	public function IsRunning()
	{
		...
		$oSet = new DBObjectSet(DBObjectSearch::FromOQL($sOQL), array('start_date' => false) /* order by*/,
			array('source_id' => $this->GetKey()) /* aArgs */, array(), 1 /* limitCount */, 0 /* limitStart */);
		if ($oSet->Count() < 1)
		{
			$bRet = false;
		}
	...
	public function GetLastCompletedImportDate()
	{
		...
		$oSet = new DBObjectSet(DBObjectSearch::FromOQL($sOQL), array('end_date' => false) /* order by*/,
			array('source_id' => $this->GetKey()) /* aArgs */, array(), 0 /* limitCount */, 0 /* limitStart */);
		if ($oSet->Count() >= 1)
		{
			$oLog = $oSet->Fetch();
...
class SynchroAttribute extends cmdbAbstractObject
{
	public static function Init()
	{
		...
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
		MetaModel::Init_AddAttribute(new AttributeExternalKey('sync_source_id', array(
		...
		MetaModel::Init_AddAttribute(new AttributeExternalField('sync_source_name',
			array('allowed_values' => null, 'extkey_attcode' => 'sync_source_id', 'target_attcode' => 'name')));
		MetaModel::Init_AddAttribute(new AttributeString('attcode', array(
			'allowed_values' => null,
			'sql' => 'attcode',
			'default_value' => null,
			'is_null_allowed' => false,
		...
		MetaModel::Init_AddAttribute(new AttributeBoolean('update', array(
			'allowed_values' => null,
			'sql' => 'update',
			'default_value' => true,
			'is_null_allowed' => false,
		...
		MetaModel::Init_AddAttribute(new AttributeBoolean('reconcile', array(
			'allowed_values' => null,
			'sql' => 'reconcile',
			'default_value' => false,
			'is_null_allowed' => false,
		...
		MetaModel::Init_AddAttribute(new AttributeEnum('update_policy', array(
		...
		MetaModel::Init_SetZListItems('list',
			array('sync_source_id', 'attcode', 'update', 'reconcile', 'update_policy')); // Attributes to be displayed for a list
		// Search criteria
...
class SynchroAttExtKey extends SynchroAttribute
{
	public static function Init()
	{
		...
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
		MetaModel::Init_AddAttribute(new AttributeString('reconciliation_attcode', array(
			'allowed_values' => null,
...
class SynchroAttLinkSet extends SynchroAttribute
{
	public static function Init()
	{
		...
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
		MetaModel::Init_AddAttribute(new AttributeString('row_separator', array(
			'allowed_values' => null,
			'sql' => 'row_separator',
			'default_value' => '|',
			'is_null_allowed' => true,
		...
		MetaModel::Init_AddAttribute(new AttributeString('attribute_separator', array(
			'allowed_values' => null,
		...
		MetaModel::Init_AddAttribute(new AttributeString('value_separator', array(
			'allowed_values' => null,
			'sql' => 'value_separator',
			'default_value' => ':',
			'is_null_allowed' => true,
...
//		MetaModel::Init_AddAttribute(new AttributeString("userinfo", array("allowed_values"=>null, "sql"=>"userinfo", "default_value"=>null, "is_null_allowed"=>true, "depends_on"=>array())));
		...
		MetaModel::Init_AddAttribute(new AttributeDateTime('start_date', array(
			'allowed_values' => null,
			'sql' => 'start_date',
			'default_value' => '',
			'is_null_allowed' => true,
		...
		MetaModel::Init_AddAttribute(new AttributeDateTime('end_date', array(
			'allowed_values' => null,
			'sql' => 'end_date',
			'default_value' => '',
			'is_null_allowed' => true,
		...
		MetaModel::Init_AddAttribute(new AttributeInteger('status_curr_job', array(
			'allowed_values' => null,
			'sql' => 'status_curr_job',
			'default_value' => 0,
			'is_null_allowed' => true,
		...
		MetaModel::Init_AddAttribute(new AttributeInteger('status_curr_pos', array(
			'allowed_values' => null,
			'sql' => 'status_curr_pos',
			'default_value' => 0,
			'is_null_allowed' => true,
		...
		MetaModel::Init_AddAttribute(new AttributeInteger('stats_nb_replica_seen', array(
			'allowed_values' => null,
		...
		MetaModel::Init_AddAttribute(new AttributeInteger('stats_nb_replica_total', array(
			'allowed_values' => null,
		...
		MetaModel::Init_AddAttribute(new AttributeInteger('stats_nb_obj_deleted', array(
			'allowed_values' => null,
		...
		MetaModel::Init_AddAttribute(new AttributeInteger('stats_nb_obj_deleted_errors', array(
			'allowed_values' => null,
		...
		MetaModel::Init_AddAttribute(new AttributeInteger('stats_nb_obj_obsoleted', array(
			'allowed_values' => null,
		...
		MetaModel::Init_AddAttribute(new AttributeInteger('stats_nb_obj_obsoleted_errors', array(
			'allowed_values' => null,
		...
		MetaModel::Init_AddAttribute(new AttributeInteger('stats_nb_obj_created', array(
			'allowed_values' => null,
		...
		MetaModel::Init_AddAttribute(new AttributeInteger('stats_nb_obj_created_errors', array(
			'allowed_values' => null,
		...
		MetaModel::Init_AddAttribute(new AttributeInteger('stats_nb_obj_created_warnings', array(
			'allowed_values' => null,
		...
		MetaModel::Init_AddAttribute(new AttributeInteger('stats_nb_obj_updated', array(
			'allowed_values' => null,
		...
		MetaModel::Init_AddAttribute(new AttributeInteger('stats_nb_obj_updated_errors', array(
			'allowed_values' => null,
		...
		MetaModel::Init_AddAttribute(new AttributeInteger('stats_nb_obj_updated_warnings', array(
			'allowed_values' => null,
		...
		MetaModel::Init_AddAttribute(new AttributeInteger('stats_nb_obj_unchanged_warnings', array(
			'allowed_values' => null,
		...
		MetaModel::Init_AddAttribute(new AttributeInteger('stats_nb_replica_reconciled_errors', array(
			'allowed_values' => null,
		...
		MetaModel::Init_AddAttribute(new AttributeInteger('stats_nb_replica_disappeared_no_action', array(
			'allowed_values' => null,
		...
		MetaModel::Init_AddAttribute(new AttributeInteger('stats_nb_obj_new_updated', array(
			'allowed_values' => null,
		...
		MetaModel::Init_AddAttribute(new AttributeInteger('stats_nb_obj_new_updated_warnings', array(
			'allowed_values' => null,
		...
		MetaModel::Init_AddAttribute(new AttributeInteger('stats_nb_obj_new_unchanged', array(
			'allowed_values' => null,
		...
		MetaModel::Init_AddAttribute(new AttributeInteger('stats_nb_obj_new_unchanged_warnings', array(
			'allowed_values' => null,
		...
		MetaModel::Init_AddAttribute(new AttributeText('last_error', array(
			'allowed_values' => null,
			'sql' => 'last_error',
			'default_value' => '',
			'is_null_allowed' => true,
		...
		MetaModel::Init_AddAttribute(new AttributeLongText('traces',
			array('allowed_values' => null, 'sql' => 'traces', 'default_value' => '', 'is_null_allowed' => true, 'depends_on' => array())));

		MetaModel::Init_AddAttribute(new AttributeInteger('memory_usage_peak', array(
			'allowed_values' => null,
		...
		MetaModel::Init_SetZListItems('list',
			array('sync_source_id', 'start_date', 'end_date', 'status', 'stats_nb_replica_seen')); // Attributes to be displayed for a list
		// Search criteria
//		MetaModel::Init_SetZListItems('standard_search', array('name')); // Criteria of the std search form
//		MetaModel::Init_SetZListItems('advanced_search', array('name')); // Criteria of the advanced search form
	}
...
class SynchroReplica extends DBObject implements iDisplay
{
	...
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeExternalField('base_class',
			array('allowed_values' => null, 'extkey_attcode' => 'sync_source_id', 'target_attcode' => 'scope_class')));

		MetaModel::Init_AddAttribute(new AttributeObjectKey('dest_id', array(
			'allowed_values' => null,
		...
		MetaModel::Init_AddAttribute(new AttributeBoolean('status_dest_creator', array(
			'allowed_values' => null,
		...
		MetaModel::Init_AddAttribute(new AttributeString('status_last_error', array(
			'allowed_values' => null,
		...
		MetaModel::Init_AddAttribute(new AttributeString('status_last_warning', array(
			'allowed_values' => null,
		...
		MetaModel::Init_AddAttribute(new AttributeDateTime('info_creation_date', array(
			'allowed_values' => null,
		...
		MetaModel::Init_AddAttribute(new AttributeDateTime('info_last_modified', array(
			'allowed_values' => null,
		...
		MetaModel::Init_SetZListItems('details', array(
				...
				'col:0' => array(
					...
					'fieldset:SynchroDataSource:Status' => array(
						'status',
						'status_last_seen',
						'status_dest_creator',
						'status_last_error',
...
//		MetaModel::Init_SetZListItems('advanced_search', array('name')); // Criteria of the advanced search form
	...
	public function Synchro($oDataSource, $aReconciliationKeys, $aAttributes, $oChange, &$oStatLog)
	{
		...
		switch ($this->Get('status'))
		{
			case 'new':
				...
				foreach ($aReconciliationKeys as $sFilterCode => $oSyncAtt)
				{
					...
					else
					{
						...
						$oStatLog->AddTrace("<<< End of SyncroReplica::Synchro (error could not reconcile on null value for attribute '$sFilterCode').",
							$this);
				...
				switch ($iCount)
				{
					...
					case 1:
						...
						if ($oDataSource->Get('action_on_one') == 'update')
						{
							...
							$oStatLog->AddTrace('Calling UpdateObjectFromReplica('.(get_class($oDestObj).'::'.$oDestObj->GetKey()).')',
								$this);
							$bModified = $this->UpdateObjectFromReplica($oDestObj, $aAttributes, $oChange, $oStatLog, 'stats_nb_obj_new',
								'stats_nb_replica_reconciled_errors');
			...
			case 'modified':
				...
				{
					$bModified = $this->UpdateObjectFromReplica($oDestObj, $aAttributes, $oChange, $oStatLog, 'stats_nb_obj',
						'stats_nb_obj_updated_errors');
					if ($this->HasWarnings())
					{
						if ($bModified)
	...
	protected function GetValueFromExtData($sExtAttCode, $oSyncAtt, &$oStatLog)
	{
			...
			if (!empty($sReconcAttCode))
			{
				...
				else
				{
					if ($rawValue != '')
					{
						...
						$oStatLog->AddTrace("Could not find [unique] object for '$sExtAttCode': searched on $sReconcAttCode = '$rawValue'",
							$this);
		...
		elseif (!is_null($oSyncAtt) && ($oSyncAtt instanceof SynchroAttLinkSet))
		{
			...
			$retValue = $oAttDef->MakeValueFromString($rawValue, $bLocalizedValue, $oSyncAtt->Get('row_separator'),
				$oSyncAtt->Get('attribute_separator'), $oSyncAtt->Get('value_separator'), $oSyncAtt->Get('attribute_qualifier'));
		}
		else
		{
...
class SynchroExecution
{
	...
	protected function PrepareLogs()
	{
		...
		$oSetTotal = new DBObjectSet(DBObjectSearch::FromOQL($sSelectTotal), array() /* order by*/,
			array('source_id' => $this->m_oDataSource->GetKey()));
	...
	public function PrepareProcessing($bFirstPass = true)
	{
		...
		$oSetAtt = new DBObjectSet(DBObjectSearch::FromOQL($sSelectAtt), array() /* order by*/,
			array('source_id' => $this->m_oDataSource->GetKey()) /* aArgs */);
	...
	protected function DoJob1UpdateReplicas($iMaxReplica = null, $iCurrPos = -1)
	{
				...
				switch ($sDeletePolicy)
				{
					...
					case 'update_then_delete':
						...
						$aToUpdateSpec = explode(';',
							$this->m_oDataSource->Get('delete_policy_update')); //ex: 'status:obsolete;description:stopped',
		...
		$oSetSeen = new DBObjectSet(DBObjectSearch::FromOQL($sSelectSeen), array() /* order by*/,
			array('source_id' => $this->m_oDataSource->GetKey(), 'last_import' => $sLastFullLoadStartDate));
	...
	protected function DoJob2CreateOrUpdateItopObjects($iMaxReplica = null, $iCurrPos = -1)
	{
		...
		if ($iMaxReplica)
		{
			// Consider a given subset, starting from replica iCurrPos, limited to the count of iMaxReplica
			// The replica have to be ordered by id
			$oSetToProcess = new DBObjectSet(DBObjectSearch::FromOQL($sSelectToSync), array('id' => true) /* order by*/,
				array('source_id' => $this->m_oDataSource->GetKey(), 'last_import' => $sLimitDate, 'curr_pos' => $iCurrPos),
				$this->m_aExtDataSpec);
			$oSetToProcess->SetLimit($iMaxReplica);
		}
		else
	...
	protected function DoJob3DeleteItopObjectsAndReplicas($iMaxReplica = null, $iCurrPos = -1)
	{
		...
		if ($iMaxReplica)
		{
			// Consider a given subset, starting from replica iCurrPos, limited to the count of iMaxReplica
			// The replica have to be ordered by id
			$oSetToProcess = new DBObjectSet(DBObjectSearch::FromOQL($sSelectToDelete), array('id' => true) /* order by*/,
				array('source_id' => $this->m_oDataSource->GetKey(), 'last_import' => $sDeletionDate, 'curr_pos' => $iCurrPos));
			$oSetToProcess->SetLimit($iMaxReplica);
		}
		else
		{
